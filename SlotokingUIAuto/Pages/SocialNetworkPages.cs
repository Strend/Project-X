...
namespace SlotokingUIAuto
{
    public class SocialNetworkPages
    {
        ...
        public IWebElement GoogleNextButton => Driver.WaitUntilVisible(By.XPath("//*[@id='identifierNext']/content/span"));
        ...
        public IWebElement GooglePassNextButton => Driver.WaitUntilVisible(By.XPath("//*[@id='passwordNext']/content/span"));
