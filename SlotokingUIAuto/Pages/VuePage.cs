...
namespace SlotokingUIAuto
{
    public class VuePopup
    {
        ...
        public IWebElement LoginEmailErrorText => Driver.WaitUntilClickable(By.XPath("//*[@id='login-type-panel']/div/div/span[1]"));
        ...
        public IWebElement RegistrationAgreeCheckBox => Driver.WaitUntilClickable(By.XPath("//*[@id='vuePopup']/div[2]/div[1]/div/div[2]/div[2]/div/div[2]/form/div[3]/label/span[4]"));
        ...
        public IWebElement CloseWizzardPopup => Driver.WaitUntilClickable(By.XPath("//*[@id='vuePopup']/div[2]/div/div[2]/span"));
        ...
        public void Auth(string login, bool isPhone)
        {
            ...
            try
            {
                if (welcome.WelcomeText.Text.Contains("Ваш подарок")) welcome.CancelButton.Click();
            }
            catch
            { }
        }
